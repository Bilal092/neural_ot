...
def get_config():
    ...
    config.c = c_ph
    config.seed = 0
    config.dataset = "mushrooms"
    config.prior = 0.518
    
    config.data = data =  config_dict.ConfigDict()
    data.dataset = "mushrooms"
    data.source = "mushrooms"
    data.target = "mushrooms"
    ...
    # train.eval_interval_steps = 5_000
    # train.save_interval_steps = 5_000
    # train.log_interval_steps = 5_000
    train.eval_interval_steps = 1000
    train.save_interval_steps = 1000
    train.log_interval_steps = 1000
